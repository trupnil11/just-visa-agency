            ...
            <ul className="vertical-menu">
                <li>
                    <a href="javaScript:void();">
                      <img src="assets/images/svg-icon/dashboard.svg" className="img-fluid" alt="dashboard" /><span>Dashboard</span><i className="feather icon-chevron-right pull-right"></i>
                    </a>
                ...
                <li>
                    <a href="javaScript:void();">
                        <img src="assets/images/svg-icon/basic.svg" className="img-fluid" alt="basic" /><span>Basic UI</span><i className="feather icon-chevron-right pull-right"></i>
                    </a>
                    <ul className="vertical-submenu">
                ...
                <li>
                    <a href="javaScript:void();">
                        <img src="assets/images/svg-icon/advanced.svg" className="img-fluid" alt="advanced" /><span>Advanced UI</span><i className="feather icon-chevron-right pull-right"></i>
                    </a>
                    <ul className="vertical-submenu">                                
                ...
                <li>
                    <a href="javaScript:void();">
                      <img src="assets/images/svg-icon/apps.svg" className="img-fluid" alt="apps" /><span>Apps</span><i className="feather icon-chevron-right pull-right"></i>
                    </a>
                    <ul className="vertical-submenu">
                        <li><a href="apps-calender.html">Calender</a></li>
                        <li><a href="apps-chat.html">Chat</a></li> 
                        <li>
                            <a href="javaScript:void();">Email<i className="feather icon-chevron-right pull-right"></i></a>
                            <ul className="vertical-submenu">
                ...
                <li>
                    <a href="javaScript:void();">
                        <img src="assets/images/svg-icon/form_elements.svg" className="img-fluid" alt="form_elements" /><span>Forms</span><i className="feather icon-chevron-right pull-right"></i>
                    </a>
                    <ul className="vertical-submenu">
                ...
                <li>
                    <a href="javaScript:void();">
                        <img src="assets/images/svg-icon/chart.svg" className="img-fluid" alt="chart" /><span>Charts</span><i className="feather icon-chevron-right pull-right"></i>
                    </a>
                    <ul className="vertical-submenu">
                ...
                <li>
                    <a href="javaScript:void();">
                        <img src="assets/images/svg-icon/icons.svg" className="img-fluid" alt="icons" /><span>Icons</span><i className="feather icon-chevron-right pull-right"></i>
                    </a>
                    <ul className="vertical-submenu">
                ...
                <li>
                    <a href="javaScript:void();">
                        <img src="assets/images/svg-icon/tables.svg" className="img-fluid" alt="tables" /><span>Tables</span><i className="feather icon-chevron-right pull-right"></i>
                    </a>
                    <ul className="vertical-submenu">
                ...
                <li>
                    <a href="javaScript:void();">
                        <img src="assets/images/svg-icon/maps.svg" className="img-fluid" alt="maps" /><span>Maps</span><i className="feather icon-chevron-right pull-right"></i>
                    </a>
                    <ul className="vertical-submenu">
                ...
                <li>
                    <a href="widgets.html">
                        <img src="assets/images/svg-icon/widgets.svg" className="img-fluid" alt="widgets" /><span>Widgets</span><span className="badge badge-success pull-right">New</span>
                    </a>
                </li>                        
                <li>
                    <a href="javaScript:void();">
                      <img src="assets/images/svg-icon/pages.svg" className="img-fluid" alt="pages" /><span>Pages</span><i className="feather icon-chevron-right pull-right"></i>
                    </a>
                    <ul className="vertical-submenu">
                        <li>
                            <a href="javaScript:void();">Basic<i className="feather icon-chevron-right pull-right"></i></a>
                            <ul className="vertical-submenu">
                        ...
                        <li>
                            <a href="javaScript:void();">Authentications<i className="feather icon-chevron-right pull-right"></i></a>
                            <ul className="vertical-submenu">
                ...
                <li>
                    <a href="javaScript:void();">
                        <img src="assets/images/svg-icon/ecommerce.svg" className="img-fluid" alt="ecommerce" /><span>eCommerce</span><i className="feather icon-chevron-right pull-right"></i>
                    </a>
                    <ul className="vertical-submenu">
